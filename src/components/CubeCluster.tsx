  ...
  return (
    <div className="relative h-full w-full">
      ...
      <Parallax speed={0} speedX={-200} className="absolute left-[-13%] top-[37%] w-[88%]">
        <img src="/hero/light-purple-cube.webp" alt="" className="w-full" />
      </Parallax>
