...
export default function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  ...
  return (
    <figure className="lift flex h-full flex-col justify-between rounded-3xl border border-[var(--border)] bg-white p-6 shadow-[0_14px_40px_-28px_rgba(22,21,28,0.5)] hover:border-[var(--accent)]/40">
      <div>
