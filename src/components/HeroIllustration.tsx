...
export default function HeroIllustration() {
  return (
    <div className="relative h-full w-full">
      ...
      <img src="/hero/floor.png" alt="" className="absolute bottom-0 left-0 w-full" />
      <img src="/hero/left-blue.png" alt="" className="absolute bottom-[39.6%] left-[19.3%] w-[33%]" />
      <img src="/hero/right-yellow.png" alt="" className="absolute bottom-[40%] right-[14.3%] w-[25%]" />
      <img
        src="/hero/pink-floor-square.png"
        alt=""
      ...
      <Parallax speed={-100} className="absolute bottom-[68%] right-[31%] w-[33%]">
        <img src="/hero/purple-top.png" alt="" className="w-full" />
      </Parallax>
      ...
      <Parallax speed={200} className="absolute left-[11%] top-[13%] hidden w-[20%] sm:block">
        <img src="/hero/white-floor-square.png" alt="" className="w-full blur-[2px]" />
      </Parallax>
    </div>
  );
}
