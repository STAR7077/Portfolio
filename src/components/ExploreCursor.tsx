  ...
  return (
    ...
    >
      ...
      {fine && (
        ...
        >
          <span className="flex items-center gap-1.5 whitespace-nowrap rounded-full border border-device bg-[var(--glass)] px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.12em] text-fg shadow-[var(--shadow-chip)] backdrop-blur-md">
            {label}
