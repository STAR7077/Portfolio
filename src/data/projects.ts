...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      en: "A booking and business-management platform for service businesses — staff calendars, automated SMS/email reminders, customer database, QR/NFC booking, and video-call appointments — used at high transactional volume across salons, clinics and professional services.",
      pt: "Uma plataforma de agendamento e gestão para empresas de serviços — agendas da equipe, lembretes automáticos por SMS/e-mail, base de clientes, agendamento por QR/NFC e consultas por videochamada — usada em alto volume transacional por salões, clínicas e serviços profissionais.",
      es: "Una plataforma de reservas y gestión para empresas de servicios — agendas del equipo, recordatorios automáticos por SMS/correo, base de clientes, reservas por QR/NFC y citas por videollamada — usada con alto volumen transaccional en salones, clínicas y servicios profesionales.",
    },
    categories: ["web"],
  ...
  },
  {
    ...
    description: {
      en: "Cloud-based legal billing and case management for law firms and professional service providers, spanning web, mobile and a Chrome extension — case/client management, time tracking, LEDES/PDF/Word invoicing, trust accounting and legal calendaring.",
      pt: "Faturamento jurídico e gestão de processos na nuvem para escritórios de advocacia e prestadores de serviços profissionais, cobrindo web, mobile e uma extensão do Chrome — gestão de casos e clientes, controle de horas, faturamento em LEDES/PDF/Word, contas de custódia e agenda jurídica.",
      es: "Facturación legal y gestión de casos en la nube para despachos de abogados y proveedores de servicios profesionales, con web, móvil y una extensión de Chrome — gestión de casos y clientes, control de horas, facturación en LEDES/PDF/Word, cuentas de fideicomiso y agenda jurídica.",
    },
    categories: ["web", "mobile"],
  ...
  },
  {
    ...
    description: {
      en: "A barter marketplace for high-value assets — watches, cars, property, yachts and jets — where members trade directly instead of buying or selling. Supports hybrid deals that pair an asset with cash, offer/counter-offer negotiation, an asset portfolio with live valuations, and a fee-free swap marketplace. Built no-code to move fast, which helped it get early traction and a seed round.",
      pt: "Um marketplace de troca para bens de alto valor — relógios, carros, imóveis, iates e jatos — em que os membros negociam diretamente em vez de comprar ou vender. Suporta negócios híbridos que combinam um bem com dinheiro, negociação por oferta e contraproposta, uma carteira de bens com avaliação em tempo real e um marketplace de trocas sem taxas. Construído em no-code para ganhar velocidade, o que ajudou a conquistar tração inicial e uma rodada seed.",
      es: "Un marketplace de intercambio para bienes de alto valor — relojes, coches, inmuebles, yates y jets — donde los miembros negocian directamente en lugar de comprar o vender. Admite acuerdos híbridos que combinan un bien con efectivo, negociación por oferta y contraoferta, una cartera de bienes con valoración en tiempo real y un marketplace de intercambios sin comisiones. Construida en no-code para ir rápido, lo que ayudó a conseguir tracción inicial y una ronda seed.",
    },
    categories: ["mobile"],
